...
def main():
    ...
    parser.add_argument("--test_lora", action="store_true", help="Run a fast check to test LoRA setup")
    ...
    lora_config = LoraConfig(
        r=8,
        lora_alpha=32,
        target_modules=["q", "v"],  # T5 uses q/k/v naming
        lora_dropout=0.1,
        bias="none",
    ...
    training_args = Seq2SeqTrainingArguments(
        ...
        fp16=False,
        bf16=torch.cuda.is_bf16_supported(),  # ✅ True on A100, otherwise False
