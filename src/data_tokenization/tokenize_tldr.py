...
DEFAULT_OUTPUT_PATH = "/gscratch/stf/mx727/tokenized_trans20_train"
...
def tokenize_and_save(data_path, output_path):
    ...
    print("🧠 Tokenizing...")
    tokenized = raw_dataset.map(tokenize_fn, batched=True, num_proc=4, remove_columns=["content", "summary"])
